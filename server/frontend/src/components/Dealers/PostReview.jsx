...
const PostReview = () => {
  ...
  return (
    <div>
      ...
      <textarea id='review' aria-label='Review' placeholder='Share your dealership experience' cols='50' rows='7' value={review} onChange={(e) => setReview(e.target.value)}></textarea>
